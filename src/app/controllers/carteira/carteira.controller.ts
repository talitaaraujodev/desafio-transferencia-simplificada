...
export class CarteiraController {
  ...
  async update(
    ...
    return await this.carteiraService.update(id, body);
  }
  @Get(':id')
  ...
  async findOne(
    ...
    return await this.carteiraService.findOne(id);
  }
  @Delete(':id')
  ...
  async delete(
    ...
    return await this.carteiraService.delete(id);
  }
}
